<template>
	<view class="content">
		<view class="container">
			<image class="backImage" src="http://t73sifiwt.hn-bkt.clouddn.com/prays/mazuback.jpg" mode=""></image>
			<view class="zhangYiNa">
				<image class="qian" src="http://t73sifiwt.hn-bkt.clouddn.com/prays/qian.png" mode="" :class="{ shake: isShaking }"></image>
			</view>
			<view class="share">摇一摇 求好签</view>
		</view>
	</view>
