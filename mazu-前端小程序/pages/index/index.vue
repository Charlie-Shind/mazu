	...
	<view class="page" v-if="isMaskLoaded">
		...
		<view class="content">
			...
			<view class="container">
				<!-- 轮播图上的卡片 -->
				<view class="show">
					<image style="position: absolute; height: 100%" src="https://mazu-1320314698.cos.ap-guangzhou.myqcloud.com/index/indexShowBack.gif" mode=""></image>
					<view class="showInfo">
						<view class="title">湄洲妈祖祖庙</view>
						<view class="info">三亿妈祖敬仰者的精神明灯</view>
					</view>
					<image class="backImage" src="https://mazu-1320314698.cos.ap-guangzhou.myqcloud.com/index/indexShowRight.png" mode=""></image>
					<view class="showBottom">
						<view class="showLeft">
							<image src="https://mazu-1320314698.cos.ap-guangzhou.myqcloud.com/index/tianhoumiao.png" mode=""></image>
							<text>天后庙</text>
						</view>
						<view class="showRight" @click.stop="to('/secondPages/webview/webview')">
							<image src="https://mazu-1320314698.cos.ap-guangzhou.myqcloud.com/index/tianhougong.png" mode=""></image>
							<view class="text">
								<view>
									<text>天后宫</text>
								</view>
	...
	data() {
		return {
			...
			gridData: [
				{
					id: 1,
					imageUrl: 'https://mazu-1320314698.cos.ap-guangzhou.myqcloud.com/index/icon/new.svg',
					text: '新闻中心',
					url: '/secondPages/news/news'
				},
				{
					id: 2,
					imageUrl: 'https://mazu-1320314698.cos.ap-guangzhou.myqcloud.com/index/icon/fu.svg',
					text: '福文化',
					url: '/secondPages/fuCulture/fuCulture'
				},
				{
					id: 3,
					imageUrl: 'https://mazu-1320314698.cos.ap-guangzhou.myqcloud.com/index/icon/xin.svg',
					text: '信俗活动',
					url: '/secondPages/faith/faith'
				},
				{
					id: 4,
					imageUrl: 'https://mazu-1320314698.cos.ap-guangzhou.myqcloud.com/index/icon/ma.svg',
					text: '妈祖文化',
					url: '/secondPages/mazuCulture/mazuCulture'
				},
				{
					id: 5,
					imageUrl: 'https://mazu-1320314698.cos.ap-guangzhou.myqcloud.com/index/icon/miao.svg',
					text: '天下宫庙',
					url: '/secondPages/palaceTemple/palaceTemple'
				},
				{
					id: 6,
					imageUrl: 'https://mazu-1320314698.cos.ap-guangzhou.myqcloud.com/index/icon/shu.svg',
					text: '数字出版',
					url: '/secondPages/publication/publication'
				},
				{
					id: 7,
					imageUrl: 'https://mazu-1320314698.cos.ap-guangzhou.myqcloud.com/index/icon/wen.svg',
					text: '妈祖文创',
					url: '/secondPages/cultureCreativity/cultureCreativity'
				},
				{
					id: 8,
					imageUrl: 'https://mazu-1320314698.cos.ap-guangzhou.myqcloud.com/index/icon/you.svg',
					text: '两岸旅游',
