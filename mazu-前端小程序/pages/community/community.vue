<template>
	...
	<view class="content">
		<view class="inputBox">
			...
			<view class="add" @click="navigatoPage('/secondPages/communityAdd/communityAdd')">
				+
			</view>
		</view>
					...
					<view class="topicContent">
						...
						<view class="topicContent">
							<view class="topicItem"
								v-for="(item, index) in sortByCommentUsers(topicRecommend).slice(0,4)"
								@click="toPage(item)">
								...
								<view class="text">
									<view class="textContent">
										...
										<view class="info">
											{{item.comment_users}}人参与讨论·{{item.topic_length*3}}点热度
										</view>
									</view>
		...
		data() {
			return {
				titleInfo: {
					titleShow: true,
					title: "社区",
					imageUrl: "https://mazu-1320314698.cos.ap-guangzhou.myqcloud.com/pageBack/4.jpg",
					heightShow: false,
					height: 300
				},
				recommend: [{
