<template>
	...
	<view class="content2">
		<view class="wxImage">
			...
			<image :show-menu-by-longpress="true" src="https://mazu-1320314698.cos.ap-guangzhou.myqcloud.com/wx.jpg" @click="previewImage" mode="aspectFit"></image>
		</view>
	</view>
</template>
		...
		methods: {
			previewImage(e) {
				...
				uni.previewImage({
					...
					urls: [],
					// 为当前显示图片的链接/索引值
					current: 'https://mazu-1320314698.cos.ap-guangzhou.myqcloud.com/wx.jpg',
					// 图片指示器样式	
					indicator: 'default',
					// 是否可循环预览
					loop: false,
