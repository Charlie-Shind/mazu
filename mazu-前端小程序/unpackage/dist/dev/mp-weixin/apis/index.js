...
const getindexGridPublicationAPI = () => {
  return utils_request.request({
...
const getindexMazuCultureItemAPI = ({
  id
}) => {
  return utils_request.request({
...
exports.getindexGridPublicationAPI = getindexGridPublicationAPI;
exports.getindexGridTourismAPI = getindexGridTourismAPI;
exports.getindexMazuCultureItemAPI = getindexMazuCultureItemAPI;
