...
if (!Array) {
  ...
  (_component_maskPage + _component_pageBack + _component_tabBar)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    h: common_vendor.o(($event) => $options.to("/secondPages/webview/webview")),
    i: common_vendor.f($data.gridData, (item, k0, i0) => {
      return {
        a: item.imageUrl,
    ...
    j: common_vendor.o(($event) => $options.to("/secondPages/news/news")),
    k: common_vendor.f($data.news.slice(7, 15), (item, index, i0) => {
      return {
        a: item.imageUrl,
    ...
    m: common_vendor.o(($event) => $options.to("/secondPages/cultureCreativity/cultureCreativity")),
    n: common_vendor.f($data.creativity, (item, index, i0) => {
      return {
        a: item.imageUrl,
        b: common_vendor.t(item.title),
